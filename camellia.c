...
inline void Camellia_DecryptBlock_Rounds(int grandRounds, const u8 ciphertext[],
    const KEY_TABLE_TYPE keyTable,
    u8 plaintext[])
{
    u32 s0, s1, s2, s3;
...
inline void Camellia_DecryptBlock(int keyBitLength, const u8 ciphertext[],
